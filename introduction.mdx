...
<CardGroup cols={2}>
  <Card title="TypeScript SDK" icon="code" href="/sdk/typescript/installation">
    One-line instrumentation for your TypeScript MCP servers
  </Card>
  <Card title="Python SDK" icon="code" href="/sdk/python/installation">
    Instrumentation for Python MCP servers built with the FastMCP or MCP SDKs
  </Card>
