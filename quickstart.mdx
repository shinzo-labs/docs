...
description: "Get your MCP server instrumented and sending data to Shinzo Platform in under 5 minutes"
---

# Quick Start Guide

Get up and running with Shinzo Platform in just a few minutes. This guide will walk you through instrumenting your MCP server and viewing telemetry data in the dashboard.
...
Run your instrumented MCP server as usual. Telemetry data will automatically be collected and sent to Shinzo Platform whenever:
...
✅ **Resource access patterns**: Which resources are accessed and how often

✅ **Server health metrics**: Memory usage, request rates
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="code" href="/sdk/typescript/api-reference">
    Complete SDK documentation and configuration options
  </Card>
</CardGroup>
