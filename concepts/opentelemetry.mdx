...
description: "Understanding OpenTelemetry and why it's the foundation of Shinzo's analytics services."
---

# What is OpenTelemetry?

OpenTelemetry (OTel) is a Cloud Native Computing Foundation (CNCF) project that merges OpenTracing and OpenCensus to provide a single, vendor-neutral framework for observability. It offers a unified approach to collecting, processing, and exporting telemetry data (traces, metrics, and logs) from applications and services.

 In particular, OTel consists of:
...
### Vendor Neutrality
By using OpenTelemetry, your telemetry data isn't locked into any specific vendor (including Shinzo). You can send data to Shinzo, other observability providers, or even run your own collection infrastructure.
...
## OpenTelemetry in the Shinzo Platform

### Automatic Instrumentation
Our TypeScript SDK automatically creates spans for MCP tool executions and error conditions, with plans to expand to other capabilities in the MCP specification.
...
The Shinzo Platform follows OpenTelemetry semantic conventions while extending them for MCP-specific concepts:
...
### Industry Standards
Using established patterns and conventions means a lower learning curve and more community resources.

### Rich Context
OpenTelemetry's attribute system provides the flexibility to add context specific to your MCP server.
...
Now that you understand the OpenTelemetry foundation, learn about our [Analytics Dashboard](/platform/dashboard) and how the Shinzo Platform unlocks product insights using this telemetry.