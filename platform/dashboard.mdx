...
<video autoPlay muted loop playsInline className="w-full aspect-video rounded-xl" src="https://shinzo.ai/videos/SpansAndTracesDemo.mp4"></video>

### Performance and Errors

<video autoPlay muted loop playsInline className="w-full aspect-video rounded-xl" src="https://shinzo.ai/videos/MetricsDemo.mp4"></video>
